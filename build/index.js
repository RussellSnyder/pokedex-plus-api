...
function setupRoutes() {
    ...
    app.get('/api/v1/stats', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, stats_controller_1.default.getAllStats()];
                case 1:
                    stats = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, generation_service_1.default.createGenerationCache()];
            case 1:
                _a.sent();
                return [4 /*yield*/, pokemon_service_1.default.createPokemonCache()];
            case 2:
                _a.sent();
                return [4 /*yield*/, stats_service_1.default.createStatCache()];
            case 3:
                _a.sent();
                pokemon_service_1.default.addNormalizedData();
