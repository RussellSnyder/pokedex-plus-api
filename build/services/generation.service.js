...
function getGenerationOfPokemon(pokemonName) {
    return __awaiter(this, void 0, void 0, function () {
        var pokemonCache;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, _getGnerationCache()];
                case 1:
                    pokemonCache = _a.sent();
                    return [2 /*return*/, pokemonCache[pokemonName]];
            }
        });
    });
}
function _getGnerationCache() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
exports.default = {
    createGenerationCache: createGenerationCache,
    getGenerationOfPokemon: getGenerationOfPokemon,
};
